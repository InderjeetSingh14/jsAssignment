...
------------------------------------------------------------------------------*/
d3.json("data33.json", function(error,data) {
  if(error) console.log("Error: data not loaded!");

  /*----------------------------------------------------------------------------
  Convert data if necessary. We want to make sure our Life expectancy at birth, total (years) vaulues are
  ...
  data.forEach(function(d) {
    d.Country = d.Country;
    d.LEB = +d.LEB;       // try removing the + and see what the console prints
    console.log(d.LEB);   // use console.log to confirm
  });

  // sort the Life expectancy at birth, total (years) values
  ...
  yScale.domain([0, d3.max(data, function(d) { return d.LEB; } ) ]);
  ...
  svg.selectAll('rect')
    ...
    .attr({
      ...
      "y": function(d) { return yScale(d.LEB); },
      "width": xScale.rangeBand(),
      "height": function(d) { return  height - yScale(d.LEB); }
    })
    .style("fill", function(d,i) { return 'rgb(20, 20, ' + ((i * 30) + 100) + ')'});
        ...
        svg.selectAll('text')
            ...
            .attr({
                ...
                "y": function(d){ return yScale(d.LEB)+ 12; },
